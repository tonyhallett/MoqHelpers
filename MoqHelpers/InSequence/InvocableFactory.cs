...
namespace MoqHelpers.InSequence
{
    internal class InvocableFactory : IInvocableFactory
    {
        ...
        {
            return new InvocableSequenceReturns<T, TReturn>(setUp, mock, sequence, new ReturnsInvocationResponder<T,TReturn>(returns,setUp,sequence.Loops));
        }
        ...
        {
            return new InvocableSequenceReturns<T, TReturn>(setUp, mock, sequence, new ReturnsInvocationResponder<T, TReturn>(returns, setUp, sequence.Loops),sequenceInvocationIndices);
        }
        ...
        {
            return new InvocableSequenceExceptionsOrReturns<T, TReturn>(setUp, mock, sequence, new ExceptionsOrReturnsInvocationResponder<T, TReturn>(exceptionsOrReturns, setUp, sequence.Loops));
        }
        ...
        {
            return new InvocableSequenceExceptionsOrReturns<T, TReturn>(setUp, mock, sequence, new ExceptionsOrReturnsInvocationResponder<T, TReturn>(exceptionsOrReturns, setUp, sequence.Loops),sequenceInvocationIndices);
        }
    }
}
