...
namespace MoqHelpers.InSequence.SetupWrappers
{
    ...
    {
        public InvocableReturn(ISetup<TMock, TReturn> wrapped,Mock mock,ISequence sequence,int times):base(wrapped,mock,sequence,times)
        {
            
        }

        public InvocableReturn(ISetup<TMock, TReturn> wrapped,Mock mock, ISequence sequence, SequenceInvocationIndices callIndices):base(wrapped,mock,sequence,callIndices)
        {
        }

        protected override void RegisterForCallback(ISetup<TMock, TReturn> wrapped,Action invokedAction)
        {
