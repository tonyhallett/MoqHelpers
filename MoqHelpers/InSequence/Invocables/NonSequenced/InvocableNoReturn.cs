...
namespace MoqHelpers.InSequence.SetupWrappers
{
    ...
    {
        public InvocableNoReturn(ISetup<TMock> wrapped,Mock mock, ISequence sequence,int consecutiveInvocations, IVerifiableWrapper verifiableWapper = null, ICallbackWrapper callbackWrapper = null) : base(wrapped,mock,sequence,consecutiveInvocations,verifiableWapper,callbackWrapper)
        {
        ...
        protected sealed override void RegisterForCallback(ISetup<TMock> wrapped, Action invokedAction)
        {
